...
urlpatterns = patterns('',
                       ...
                       url(r'^export/$', 'base.views.export'),
                       url(r'^exhibition/$', 'base.views.exhibitions'),
                       url(r'^auctions/$', 'base.views.auctions'),
                       url(r'^exhibition/(?P<pk>\d+)$', 'base.views.exhibition'),
                       url(r'^bibliography/$', 'base.views.bibliographies'),
                       url(r'^bibliography/(?P<pk>\d+)$', 'base.views.bibliography'),
                       ...
                       url(r'^selection/untag/$', 'base.views.selection_untag'),
