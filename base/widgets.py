            ...
            (function ($) {
                ...
                $(document).ready(function (){
                    ...
                    $("#%(widget_id)s").autoSuggest("%(url)s", {
                        ...
                        minChars: 1,
                        selectionAdded: function (element) { tagname = $(element).contents(":not(a)").text(); if (michaux.tag_selection !== undefined) michaux.tag_selection(tagname); },
                        selectionRemoved: function (element) { tagname = $(element).contents(":not(a)").text(); if (michaux.tag_selection !== undefined) michaux.untag_selection(tagname); return false; },
                        neverSubmit: true
                    });
